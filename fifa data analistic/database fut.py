...
columns = ['ID','Nom', 'Age', 'Nationalité', 'General', 'Potentiel', 'Club',  'Valeur', 'Salaire']
...
for i in range(0, 335):
    ...
    for row in table_body.findAll('tr'):
        ...
        player_data = pd.DataFrame([[pid,name, age,  nationality,  overall, potential, club, value, wage]])
...
for id in data["ID"][:20]:
    ...
    skill_map = {}
    columnn = soup.find("div", {"class":"columns"})
    columns12 = columnn.find("div",{"class":"column col-12"})
